...
ArrayRef<const char *> RISCVTargetInfo::getGCCRegNames() const {
  static const char *const GCCRegNames[] = {
      ...
      // Posit floating point registers
...
ArrayRef<TargetInfo::GCCRegAlias> RISCVTargetInfo::getGCCRegAliases() const {
  static const TargetInfo::GCCRegAlias GCCRegAliases[] = {
      ...
      {{"pt0"}, "p0"},  {{"pt1"}, "p1"},  {{"pt2"}, "p2"},   {{"pt3"}, "p3"},
      {{"pt4"}, "p4"},  {{"pt5"}, "p5"},  {{"pt6"}, "p6"},   {{"pt7"}, "p7"},
      {{"ps0"}, "p8"},  {{"ps1"}, "p9"},  {{"pa0"}, "p10"},  {{"pa1"}, "p11"},
      {{"pa2"}, "p12"}, {{"pa3"}, "p13"}, {{"pa4"}, "p14"},  {{"pa5"}, "p15"},
      {{"pa6"}, "p16"}, {{"pa7"}, "p17"}, {{"ps2"}, "p18"},  {{"ps3"}, "p19"},
      {{"ps4"}, "p20"}, {{"ps5"}, "p21"}, {{"ps6"}, "p22"},  {{"ps7"}, "p23"},
      {{"ps8"}, "p24"}, {{"ps9"}, "p25"}, {{"ps10"}, "p26"}, {{"ps11"}, "p27"},
      {{"pt8"}, "p28"}, {{"pt9"}, "p29"}, {{"pt10"}, "p30"}, {{"pt11"}, "p31"}};
